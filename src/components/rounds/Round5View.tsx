...
export function Round5View() {
  ...
  const round5NextQuestion = useGameStore((s) => s.round5NextQuestion);
  ...
  return (
    <div className="flex flex-1 flex-col gap-6">
      ...
      <PresenterControls
        ...
        onNext={round5NextQuestion}
        nextLabel="Siguiente pregunta"
        correctLabel="Acierto — sube peldaño (A)"
        wrongLabel="Fallo — pasa turno (F)"
      />
    </div>
  );
}
